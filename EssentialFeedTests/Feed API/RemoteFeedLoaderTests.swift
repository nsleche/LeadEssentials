...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversErrorOnClientError() {
        ...
        expect(sut, toCompleteWithResult: .failure(RemoteFeedLoader.RemoteFeedLoaderError.connectivity)) {
    ...
    func test_load_deliversErrorOnNon200HTTPResponse() {
        ...
        samples.enumerated().forEach { (index, code) in
            expect(sut, toCompleteWithResult: .failure(RemoteFeedLoader.RemoteFeedLoaderError.invalidData)) {
